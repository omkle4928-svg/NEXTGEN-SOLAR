            ...
            <div className="space-y-8 lg:border-l lg:border-slate-100 lg:pl-8">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  {consumer.supportingDoc1 && (
                    <div className="group border border-slate-100 rounded-2xl overflow-hidden shadow-sm bg-slate-50 relative">
                      <div className="aspect-[3/2] w-full overflow-hidden bg-slate-100 relative">
                        <img 
                          src={consumer.supportingDoc1} 
                          alt="Supporting Document 1" 
                          className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105"
                          referrerPolicy="no-referrer"
                        />
                        <div className="absolute inset-0 bg-slate-900/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center space-x-2">
                          <button 
                            onClick={() => setLightboxImage({ src: consumer.supportingDoc1!, title: 'Supporting Document 1' })}
                            className="p-2 bg-white/95 hover:bg-white text-slate-800 rounded-xl shadow-lg transition-transform focus:outline-none hover:scale-105"
                            title="View Enlarged"
                          >
                            <Eye className="w-4 h-4" />
                      ...
                      <div className="px-4 py-2.5 bg-white border-t border-slate-100 flex items-center justify-between">
                        <span className="text-xs font-semibold text-slate-700">Supporting Document 1</span>
                        <span className="text-[10px] font-mono bg-cyan-50 text-cyan-700 px-1.5 py-0.5 rounded">Optional</span>
                      </div>
                    </div>
                  )}

                  {/* SUPPORTING DOCUMENT 2 */}
                  {consumer.supportingDoc2 && (
                    <div className="group border border-slate-100 rounded-2xl overflow-hidden shadow-sm bg-slate-50 relative">
                      <div className="aspect-[3/2] w-full overflow-hidden bg-slate-100 relative">
                        <img 
                          src={consumer.supportingDoc2} 
                          alt="Supporting Document 2" 
                          className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105"
                          referrerPolicy="no-referrer"
                        />
                        <div className="absolute inset-0 bg-slate-900/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center space-x-2">
                          <button 
                            onClick={() => setLightboxImage({ src: consumer.supportingDoc2!, title: 'Supporting Document 2' })}
                            className="p-2 bg-white/95 hover:bg-white text-slate-800 rounded-xl shadow-lg transition-transform focus:outline-none hover:scale-105"
                            title="View Enlarged"
                          >
                            <Eye className="w-4 h-4" />
                      ...
                      <div className="px-4 py-2.5 bg-white border-t border-slate-100 flex items-center justify-between">
                        <span className="text-xs font-semibold text-slate-700">Supporting Document 2</span>
                        <span className="text-[10px] font-mono bg-cyan-50 text-cyan-700 px-1.5 py-0.5 rounded">Optional</span>
                      </div>
                    </div>
                  )}
